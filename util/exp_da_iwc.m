...
% Write results
di = 1; while exist([p.Results.saveName 'results_da_iwc_' p.Results.iwe '_' p.Results.clf '_' num2str(di) '.mat'], 'file')~=0; di = di+1; end
fn = [p.Results.saveName 'results_da_iwc_' p.Results.iwe '_' p.Results.clf '_' num2str(di)];
