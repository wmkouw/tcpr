function exp_ssb_t3(varargin)
% Sample selection bias experiments on the tic-tac-toe dataset
...
try
    ...
    cd('../data/t3')
    [D,y] = get_t3('save', true);
    copyfile t3.mat ../../experiment-t3/
    cd('../../experiment-t3')
end 
