function exp_ssb_mamm(varargin)
% Sample selection bias experiments on the mammographic masses dataset
...
try
    ...
    cd('../data/mamm')
    [D,y] = get_mamm('save', true);
    copyfile mamm.mat ../../experiment-mamm/
    cd('../../experiment-mamm')
end 
