function exp_ssb_bands(varargin)
% Sample selection bias experiments on the cylinder bands dataset
...
try
    ...
    cd('../data/bands')
    [D,y] = get_bands('save', true);
    copyfile bands.mat ../../experiment-bands/
    cd('../../experiment-bands')
end 
