function exp_ssb_car(varargin)
% Sample selection bias experiments on the car evaluation dataset
...
try
    ...
    cd('../data/car')
    [D,y] = get_car('save', true);
    copyfile car.mat ../../experiment-car/
    cd('../../experiment-car')
end 
