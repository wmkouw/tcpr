% Objective function for robust regression with L_2 loss
...
function [f, g, alpha, L] = funcRobReg(theta, K, y, Ktr, Kt_t, Kt_ref, Kref_ref, beta, gamma, B)
    [~, k] = size(Kt_ref);
    yhat = K*theta;
    l = yhat - y;
    f1 = Kt_ref'*(l.^2); % quadratic loss
