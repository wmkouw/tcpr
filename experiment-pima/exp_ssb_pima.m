function exp_ssb_pima(varargin)
% Sample selection bias experiments on the pima diabetes dataset
...
try
    ...
    cd('../data/pima')
    [D,y] = get_pima('save', true);
    copyfile pima.mat ../../experiment-pima/
    cd('../../experiment-pima')
end 
